import{c as o,r as n,m as i}from"./render-template.Dqv0hIb6.js";import{u as a}from"./hoisted.BFWYe-Q9.js";import"./astro/assets-service.3IbH0_Ak.js";const t=`<h2 id="tldr">tldr</h2>
<ol>
...
`}function b(){return t}function f(){return[{depth:2,slug:"tldr",text:"tldr"},{depth:2,slug:"what-are-webmentions",text:"What are webmentions"},{depth:2,slug:"steps-to-add-it-to-your-own-site",text:"Steps to add it to your own site"},{depth:2,slug:"testing-everything-works",text:"Testing everything works"},{depth:2,slug:"things-to-add-things-to-consider",text:"Things to add, things to consider"},{depth:2,slug:"acknowledgements",text:"Acknowledgements"}]}const w=o((d,h,u)=>{const{layout:c,...e}=s;return e.file=r,e.url=l,n`${i()}${a(t)}`});export{w as Content,b as compiledContent,w as default,r as file,s as frontmatter,f as getHeadings,g as rawContent,l as url};
